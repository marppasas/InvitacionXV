...
class ControllerBase {
    ...
    protected function BadRequest(string $body = NULL): HttpResponse
    {
        return $this->Response('HTTP/1.1 400 Bad Request', 400, $body);
    }
    ...
    protected function Forbidden(string $body = NULL): HttpResponse
    {
        return $this->Response('HTTP/1.1 403 Forbidden', 403, $body);
    }
